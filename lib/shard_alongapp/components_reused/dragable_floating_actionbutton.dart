...
class DraggableFloatingActionButton extends StatefulWidget {
  ...
  DraggableFloatingActionButton({Key? key,
    required this.child,
    required this.initialOffset,
    required this.onPressed, required ,required this.parentKey
  }) : super(key: key);
...
class _DraggableFloatingActionButtonState extends State<DraggableFloatingActionButton> {
  ...
  void _setBoundary(_) {
    final  parentRenderBox = widget.parentKey.currentContext?.findRenderObject() as RenderBox;
